...
-- Use este script somente no schema antigo:
-- projects(id_project, title, imagesrc, description, projectlink)
-- technologies(id_technologies, name, iconsrc)
-- projects_technologies(id_project, id_technologie)
